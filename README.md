...
This repository contains Pyronome **React.js 16.x for Laravel 6.x** pattern basic information, pattern files, pattern templates, documentation and issue tracker. For further information about this pattern, please visit https://pyronome.com/pyronome/reactjs-16x-laravel-6x.
...
Please refer to the [Getting Started](https://github.com/pyronome/pattern-reactjs-16x-laravel-6x#getting-started) section for step by step instructions.
...
Please follow the steps below to generate source code using **React.js 16.x for Laravel 6.x** pattern:
...
4. Please choose **React.js 16.x for Laravel 6.x** pattern on Install Pattern(s) dialog.
...
Please use the [issue tracker](https://github.com/pyronome/pattern-reactjs-16x-laravel-6x/issues) to report any bugs/typos or requests.

## Versioning

We use [SemVer](http://semver.org/) for versioning. For the versions available, see releases section of the [pattern overview page](https://pyronome.com/pyronome/reactjs-16x-laravel-6x#Overview). 
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/pyronome/pattern-reactjs-16x-laravel-6x/blob/master/LICENSE) file for details
